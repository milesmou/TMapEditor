...
{
    private static readonly Color PanelBrush = new(37, 40, 45);
    private static readonly Color BorderBrushColor = new(59, 64, 72);
    private static readonly Color ToolbarBrush = new(43, 46, 51);
    private static readonly Color StatusBrush = new(41, 44, 49);
    private static readonly Color BackgroundBrush = new(30, 32, 36);
    private static readonly Color ButtonBrush = new(52, 56, 63);
    private static readonly Color ButtonBorder = new(85, 91, 100);
    private static readonly Color TextBrush = new(232, 232, 232);
    private static readonly Color DimTextBrush = new(158, 165, 176);
    private static readonly Color ResourceSelectedBrush = new(18, 82, 108);
    private static readonly Color ResourceHoverBrush = new(44, 49, 56);
    private static readonly Color AccentBrush = new(0, 180, 255);
    ...
    private static string FormatDisplayColor(Color color) =>
